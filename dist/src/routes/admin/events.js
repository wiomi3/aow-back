...
async function checkCollisions(employeeIds, startAt, endAt, excludeEventId) {
...
events.openapi(createEventRoute, async (c) => {
    const { title, description, startAt, endAt, typeId, locationId, employeeIds } = c.req.valid('json');
